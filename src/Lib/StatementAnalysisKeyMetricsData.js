...
var StatementAnalysisKeyMetricsData = /** @class */ (function () {
    function StatementAnalysisKeyMetricsData(dataObjectIn) {
    ...
    StatementAnalysisKeyMetricsData.prototype.toString = function () {
    ...
    return StatementAnalysisKeyMetricsData;
}());
exports.default = StatementAnalysisKeyMetricsData;
