...
var StandardCharData = /** @class */ (function () {
    function StandardCharData(dateOfClosein, dailyClosingPriceIn, simpleMovingAverageIn, expMovingAverageIn, twoHundredDayMovingAverageIn, fiftyDayMovingAverageIn, lowerBollingerValueIn, upperBollingerValueIn, meanIn) {
    ...
    */
    StandardCharData.prototype.toString = function () {
    ...
    return StandardCharData;
}());
exports.default = StandardCharData;
